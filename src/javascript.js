...
function generateRecipe(event) {
  ...
  recipeElement.innerHTML = `<div class="blink"> 🍽️ Generating a recipe including ${instructionsInput.value} for you. </div>`;
